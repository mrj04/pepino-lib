...
DDPClient.prototype.connect = function(callback) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var removeListeners = function () {
      ...
      self.removeListener("failed", onFailed);
    };
    ...
    self.once("connected", onConnected);
    self.once("failed", onFailed);
...
DDPClient.prototype.call = function(name, params) {

  var updatedCallback = null;

  if (typeof arguments[arguments.length - 1] === 'function') {
    updatedCallback = Array.prototype.pop.call(arguments);
  }

  // match Meteor call syntax
  params = Array.prototype.slice.call(arguments, 1);

  return this.apply.apply(this, [name, params, updatedCallback]);

};

DDPClient.prototype.apply = function(name, params) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    self._callbacks[id] = function (err, res) {
